...
public class EjemploJacksonJson {
    public static void main(String[] args) throws IOException {
        //TIP Press <shortcut actionId="ShowIntentionActions"/> with your caret at the highlighted text
        // to see how IntelliJ IDEA suggests fixing it.
        Alumno alumno1 = new Alumno(1,"Manolo", "García", 8,LocalDate.of(2000,01,16));
        Alumno alumno2 = new Alumno(2,"Ana", "Quiralte", 7,LocalDate.of(2002,04,18));
        Alumno alumno3 = new Alumno(3,"Antonio", "Pérez", 4,LocalDate.of(2003,05,06));
